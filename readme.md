User Activity Log plugin for [AMGPortal - Advanced PHP Login and User Management]([https://vanguardapp.io](https://portal.alchemymedia.io/))
system.
...
```
composer require amgportal/activity-log
```
